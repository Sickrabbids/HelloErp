	...
	<div class="container" id="car1">
		<div id="carousel-example-generic" class="carousel slide"
			...
			<div class="carousel-inner" align="center" id="rr">
				<!-- class="carousel-inner" : 없으면 이미지 3장이 모두 세로로 배치된다.  -->
				<div class="item active">
					<img src='${pageContext.request.contextPath}/resources/images/dresses.jpg' alt="First slide" id="cimg">
					 <!-- <div class="carousel-caption">
                        <h3></h3>
                     </div>  --> 
				</div>
				<div class="item">
					<img src='${pageContext.request.contextPath}/resources/images/book.jpg' alt="Second slide" id="cimg">
						<!-- <div class="carousel-caption">
                        <h3></h3>
                     </div>  -->
				</div>
				<div class="item">
					<img src='${pageContext.request.contextPath}/resources/images/shoes.jpg' alt="Third slide" id="cimg">
						<!-- <div class="carousel-caption">
                        <h3></h3>
                     </div>  -->
				</div>
									...
									<div class="panel panel-primary" align="center">
										...
										<form action="erpmain">
											<table class="table">
												...
												<tr align="center">
													<td><input type="password" class="form-control" name='m_pwd'
														placeholder="비밀번호를 입력해주세요"></td>
												</tr>
												<tr align="center">
